...
public class interfaceAjoutPension extends javax.swing.JFrame {

    /**
     * Creates new form interfacePension
     */
    public interfaceAjoutPension() {
        initComponents();
this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        ...
        List <Prestataire> listprest =new ArrayList<Prestataire>();
                ...
                listprest = prestDAO.getALLPrestataireByDomaine("pensionnaire");
                System.out.println(listprest.size());
                for (int i=0; i<listprest.size();i++) {
                    ...
                    comboBoxItems.add(ch);

                }
         final DefaultComboBoxModel model = new DefaultComboBoxModel(comboBoxItems);
         jComboBox1.setModel(model);
//        pensionDAO pensDAO = new pensionDAO();
//        prestataireDAO prestDAO = new prestataireDAO();
//        List<prestataire> list = new ArrayList<prestataire>() ;
//        list = prestDAO.getALLPrestataire();
...
//        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(244, 147, 119));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel2.setText("Ajouter pension:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int tel = Integer.parseInt(jTextField3.getText().toString());
        String nom_prest = jComboBox1.getSelectedItem().toString() ;
        System.out.println("NOM prest "+nom_prest);
        int id_prest= prestDAO.getIDPrestataireByName(nom_prest);
        System.out.println("ID PREST "+id_prest);
        p.setNom(nom);
        p.setAdresse(adr);
        p.setTelephone(tel);
        p.setId_prest(id_prest);
        pDAO.insertPension(p);
        JOptionPane.showMessageDialog(this, "Ajout de la pension est effectué avec succés");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new interfaceAjoutPension().setVisible(true);
            }
        });
    }
