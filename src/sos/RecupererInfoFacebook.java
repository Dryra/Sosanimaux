...
//jf.add(pn);
           ...
           da.insertadherantbyfacebook(informations,imgfile);
            ...
            JOptionPane.showMessageDialog(null, "Veuillez changer votre mot de passe ");
...
post();
    ...
    public  void post()
    {
        FacebookClient facebookClient = new DefaultFacebookClient("CAADiEqZCqAucBANcHZCHIYQLDNS0nE1JQnGwucSV5eTJl5JsfgxXnBTrsmn19np5dbvj2O3bgZC70Aldtjjbh5BqZASkFsqQlnqWqdfsIQZBn2Rs2PYwRu5JtyZCRj0rAK9bB3uyukIBMmhfQycmB0Aj84etJFnLNvsDrH3aZCo4G21UyjajNa1");
        ...
        FacebookType publishMessageResponse =
                  facebookClient.publish(connection, FacebookType.class,
                    Parameter.with("message", "I am using the new Desk app SOSanimaux :D"));
//        FacebookType publishPhotoResponse = facebookClient.publish("me/photos", FacebookType.class,BinaryAttachment.with("holiMan.jpg",RecupererInfoFacebook.class.getResourceAsStream("holiMan.jpg")),Parameter.with("message", "The HOLI MAN"));
